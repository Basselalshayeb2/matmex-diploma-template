...
\define@key[ru]{mytitle}{teacher}{\def\my@title@teacher@ru{#1}}
...
\define@choicekey*[ru]{mytitle}{type}{coursework,singlework,groupwork,practice,prediploma,master,bachelor,production}{\def\my@title@type@ru{#1}}
\define@choicekey*[ru]{mytitle}{kind}{solution,none,experiment,production,comparison,theoretical}{\def\my@title@kind@ru{#1}}
...
\define@key[en]{mytitle}{teacher}{\def\my@title@teacher@en{#1}}
...
\define@choicekey*[en]{mytitle}{type}{coursework,singlework,groupwork,practice,prediploma,master,bachelor}{\def\my@title@type@en{#1}}
\define@choicekey*[en]{mytitle}{kind}{solution,none,experiment,production,comparison,theoretical}{\def\my@title@kind@en{#1}}
